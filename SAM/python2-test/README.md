...
This is a sample template for python2-test - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name python2-test --query 'Stacks[].Outputs'
```
