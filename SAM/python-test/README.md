...
This is a sample template for python-test - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name python-test --query 'Stacks[].Outputs'
```
